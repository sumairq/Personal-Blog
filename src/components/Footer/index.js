...
const Footer = () => {
  ...
  return (
    <footer className='mt-16 rounded-2xl bg-dark m-10 flex flex-col items-center text-light'>
      ...
      <input className='w-full bg-transparent pl-0 text-dark focus:border-dark focus:ring-0 border-0 border-b mr-2 pb-1'
       type="email" placeholder="Enter your email" {...register("Email", {required: true, pattern: /^\S+@\S+$/i})} />
    ...
    <div className='flex items-center mt-8'>
      ...
      <div className='w-full mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between'>
        ...
        <div className='text-center'>
            Made with &hearts; by <a href="http://" className='underline'>Sumair</a>
        </div>
      </div>
        </footer>
  )
